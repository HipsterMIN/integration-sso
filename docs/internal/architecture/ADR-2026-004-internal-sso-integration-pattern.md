...
**결정자**: PM, 아키텍트  
**관련 코드**: `idem-hub/src/main/java/io/github/hipstermin/idem/idem-hub/domain/AgencyMeta.java` (integrationType: INTERNAL_SSO)
...
- `idem-hub/src/main/java/io/github/hipstermin/idem/idem-hub/domain/AgencyMeta.java` (integrationType 필드)

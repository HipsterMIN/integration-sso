...
> **환경변수**: `IDEM_HUB_RETENTION_ENABLED` / `IDEM_HUB_RETENTION_DRY_RUN`  
...
```
IDEM_HUB_RETENTION_ENABLED=true + IDEM_HUB_RETENTION_DRY_RUN=false
...
IDEM_HUB_RETENTION_ENABLED=true
IDEM_HUB_RETENTION_DRY_RUN=true    # 삭제 없이 로그만
...
IDEM_HUB_RETENTION_DRY_RUN=false   # 실제 삭제!

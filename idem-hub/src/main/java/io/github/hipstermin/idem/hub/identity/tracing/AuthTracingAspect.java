package io.github.hipstermin.idem.hub.identity.tracing;
...
public class AuthTracingAspect {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    @Around("execution(* io.github.hipstermin.idem.hub.identity.spi.IdentityVerificationController.initiate(..))")
    ...
    @Around("execution(* io.github.hipstermin.idem.hub.identity.spi.IdentityVerificationController.complete(..))")

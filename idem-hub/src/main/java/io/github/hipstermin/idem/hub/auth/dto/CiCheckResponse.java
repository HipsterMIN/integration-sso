...
public class CiCheckResponse {
     ...
     *
     * <p>Q-IM CI 조회는 {@link io.github.hipstermin.idem.hub.auth.service.AuthService#checkNiceCi}에서
     * {@link io.github.hipstermin.idem.hub.auth.port.ImApiOutPort#findByCi}를 통해 실제 구현됨 (S7-T6 완료).
     */
     ...
     *
     * <p>Q-IM {@link io.github.hipstermin.idem.hub.auth.dto.im.QimMemberInfo#getIndvlMbrId}에서 추출.
     ...
     *
     * <p>Q-IM {@link io.github.hipstermin.idem.hub.auth.dto.im.QimMemberInfo#getCmpMbrId}에서 추출.

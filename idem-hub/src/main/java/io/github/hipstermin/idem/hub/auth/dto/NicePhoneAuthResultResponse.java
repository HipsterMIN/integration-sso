...
public class NicePhoneAuthResultResponse {
    ...
    public static class ResultData {
         ...
         *
         * <p><b>S7-T6 구현 완료:</b>
         * CI는 {@link io.github.hipstermin.idem.hub.auth.service.NiceAuthService#getNicePhoneAuthResult}에서
         * 복호화 후 {@link io.github.hipstermin.idem.hub.auth.port.ImApiOutPort#register}를 통해 Q-IM에 등록됨.

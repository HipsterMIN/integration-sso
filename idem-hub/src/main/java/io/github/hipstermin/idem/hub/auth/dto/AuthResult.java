 ...
 * {@link io.github.hipstermin.idem.hub.auth.port.ImApiOutPort#register}를 통해 Q-IM에 CI/개인정보를 등록할 때 사용한다.
 *
 * <p><b>보안 원칙 (Q3=B):</b>
 ...
 * <p><b>S7-T6 구현 완료:</b>
 * <ul>
 *   <li>OACX 간편서명 완료 후 → {@link io.github.hipstermin.idem.hub.auth.service.AuthService#handleOacxEasysign} 에서 Q-IM 등록</li>
 *   <li>NICE 휴대폰 인증 완료 후 → {@link io.github.hipstermin.idem.hub.auth.service.NiceAuthService#getNicePhoneAuthResult} 에서 Q-IM 등록</li>
 * </ul>
 */
@Data
@Builder

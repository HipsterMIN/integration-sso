 ...
 *
 * 구현체: {@link kr.go.smes.ido.broker.nonoidc.NonOidcBrokerAdapter}
 * 진입점: {@link kr.go.smes.ido.broker.nonoidc.NonOidcBrokerController}
 *
...
public interface IdpBrokerService {
     ...
     *
     * <p>구현체({@link kr.go.smes.ido.broker.nonoidc.NonOidcBrokerAdapter})에서

...
-- ═══════════════════════════════════════════════════════════════════════════
DELETE FROM idem_hub.agency_endpoint_registry
...
DELETE FROM idem_hub.agency_rate_limit_config
 WHERE agency_code IN ('AGENCY_STUB_001','AGENCY_BRIDGE_001','AGENCY_APACHEGATE_001','AGENCY_SSO_001','AGENCY_STRICT_L3','AGENCY_CHAOS_001');
DELETE FROM idem_hub.agency_webhook_config
 WHERE agency_code IN ('AGENCY_STUB_001','AGENCY_BRIDGE_001','AGENCY_APACHEGATE_001','AGENCY_SSO_001','AGENCY_STRICT_L3','AGENCY_CHAOS_001');
DELETE FROM idem_hub.agency_meta
 WHERE agency_code IN ('AGENCY_STUB_001','AGENCY_BRIDGE_001','AGENCY_APACHEGATE_001','AGENCY_SSO_001','AGENCY_STRICT_L3','AGENCY_CHAOS_001');

package kr.go.smes.ido.auth.spi;

import kr.go.smes.common.domain.AuthResult;
import kr.go.smes.common.spi.identity.AuthWidgetDescriptor;
import kr.go.smes.common.spi.identity.IdentityProviderRegistry;

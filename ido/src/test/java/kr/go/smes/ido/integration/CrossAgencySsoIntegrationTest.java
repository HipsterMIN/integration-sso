...
import kr.go.smes.ido.sso.CastTokenService;
...
class CrossAgencySsoIntegrationTest extends IntegrationTestBase {
    ...
    void s13T2_issueCastToken_noSession_throws() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            kr.go.smes.common.error.PlatformException.class,
    ...
    void s13T3_issueCastToken_unknownAgency_throws() {
        ...
        // When & Then
        kr.go.smes.common.error.PlatformException ex =
            org.junit.jupiter.api.Assertions.assertThrows(
                kr.go.smes.common.error.PlatformException.class,
        ...
        assertThat(ex.getErrorCode())
                .isEqualTo(kr.go.smes.common.error.PlatformErrorCode.AGENCY_NOT_REGISTERED);
    }
    ...
    void s13T5_verifyCastToken_reuse_conflict() {
        ...
        assertThat(ex.getErrorCode())
                .isEqualTo(kr.go.smes.common.error.PlatformErrorCode.SSO_CAST_CONSUMED);
    }
    ...
    void s13T6_verifyCastToken_agencyMismatch() {
        ...
        assertThat(ex.getErrorCode())
                .isEqualTo(kr.go.smes.common.error.PlatformErrorCode.SSO_CAST_AGENCY_MISMATCH);
    }

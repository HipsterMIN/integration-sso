...
import kr.go.smes.ido.broker.anyid.AnyIdBrokerAdapter;
import kr.go.smes.ido.broker.keycloak.KeycloakProperties;
import kr.go.smes.ido.broker.provider.ProviderConfig;
import kr.go.smes.ido.broker.provider.ProviderConfigRepository;
import kr.go.smes.ido.broker.provider.ProviderRouter;
 ...
 *
 * @see ProviderRouter
 * @see kr.go.smes.ido.broker.anyid.AnyIdBrokerAdapter
 * @see kr.go.smes.ido.broker.nonoidc.NonOidcBrokerAdapter
 */
@Slf4j
@Service
...
public class BrokerService {
     ...
     * (현재는 {@link kr.go.smes.ido.broker.nonoidc.NonOidcBrokerController}가 별도 경로 보유).
     */
     ...
     * 경로를 통해 {@link kr.go.smes.ido.broker.nonoidc.NonOidcBrokerController}가 처리.
     */

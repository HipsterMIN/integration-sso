package kr.go.smes.ido.infrastructure.health;
 ...
 *
 * @see KmsClient
 * @see kr.go.smes.ido.crypto.kms.VaultKmsClient
 * @see kr.go.smes.ido.crypto.kms.LocalKmsClient
 */
@Slf4j
...
public class VaultKmsHealthIndicator implements HealthIndicator {
     ...
     * {@link kr.go.smes.ido.crypto.kms.AnyIdKmsClient}는 별도 prefix(ido.anyid.kms)를 사용하므로
     * {@link kr.go.smes.ido.crypto.kms.LocalKmsClient}와 동시에 활성화될 수 있다.

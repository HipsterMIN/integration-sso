...
public interface AgencyGatewayService {
     ...
     * @throws kr.go.smes.common.error.PlatformException PROV_IDEMPOTENCY_CONFLICT(E-PROV-503): 중복 이벤트
     * @throws kr.go.smes.common.error.PlatformException PROV_INBOUND_REJECTED(E-PROV-504): 처리 거부
     */
     ...
     * @throws kr.go.smes.common.error.PlatformException PROV_AGENCY_ENDPOINT_NOT_FOUND(E-PROV-501): 엔드포인트 없음
     */

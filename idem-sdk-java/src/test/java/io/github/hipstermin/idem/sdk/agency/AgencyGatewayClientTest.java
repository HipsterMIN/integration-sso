package io.github.hipstermin.idem.sdk.agency;
...
import io.github.hipstermin.idem.sdk.agency.security.HmacSigner;
...
class AgencyGatewayClientTest {
    ...
    void gap3_retryOn5xx_succeedsOnSecondAttempt() throws Exception {
        ...
        io.github.hipstermin.idem.sdk.agency.http.HttpUrlConnectionAdapter adapter =
                new io.github.hipstermin.idem.sdk.agency.http.HttpUrlConnectionAdapter(3_000, 5_000, 3, 1L);
    ...
    void gap3_retryExhausted_throwsLastException() {
        ...
        io.github.hipstermin.idem.sdk.agency.http.HttpUrlConnectionAdapter adapter =
                new io.github.hipstermin.idem.sdk.agency.http.HttpUrlConnectionAdapter(3_000, 5_000, 1, 1L);

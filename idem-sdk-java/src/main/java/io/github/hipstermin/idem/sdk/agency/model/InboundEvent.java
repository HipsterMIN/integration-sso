package io.github.hipstermin.idem.sdk.agency.model;
...
public final class InboundEvent {
    ...
    private InboundEvent(Builder builder) {
        ...
        this.idempotencyKey = (builder.idempotencyKey != null && !builder.idempotencyKey.isEmpty())
                              ...
                              : io.github.hipstermin.idem.sdk.agency.idempotency.IdempotencyKeyGenerator.generate();
    ...
    public static final class Builder {
         ...
         * 멱등성 키 설정 (선택).
         *
         * <p>설정하지 않으면 {@link io.github.hipstermin.idem.sdk.agency.idempotency.IdempotencyKeyGenerator#generate()}로
         * UUID v4를 자동 생성한다.

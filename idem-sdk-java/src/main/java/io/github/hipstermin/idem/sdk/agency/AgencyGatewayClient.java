...
import io.github.hipstermin.idem.sdk.agency.http.HttpUrlConnectionAdapter;
...
public final class AgencyGatewayClient {
     ...
     * @throws io.github.hipstermin.idem.sdk.agency.exception.AgencyHttpException HTTP 오류 시
     */

 ...
 *   ./gradlew :idem-sdk-java:publish
 *
 * 내부 Nexus 전용 배포 (서명 생략):
 *   SKIP_SIGNING=true ./gradlew :idem-sdk-java:publish
 *
...
// (루트 build.gradle.kts의 idem-sdk-java 블록에서 Jar enabled=true 설정)
...
//
// 배포 명령:
//   ./gradlew :idem-sdk-java:publish                 (전체 저장소)
//   ./gradlew :idem-sdk-java:publishToMavenLocal     (로컬 ~/.m2 테스트)
//
// ──────────────────────────────────────────────────────────────────────────────

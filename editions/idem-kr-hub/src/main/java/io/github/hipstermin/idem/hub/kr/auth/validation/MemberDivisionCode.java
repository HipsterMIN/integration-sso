...
/**
 * 회원 구분 코드(mbrDvsnCd) 가 {@code idem.hub.registry.member-division-codes} 허용 목록에 있는지 검증한다.
 *
 * <p>null 은 통과시킨다 — 필수 여부는 {@code @NotBlank} 가 담당한다.
 * 허용 목록은 {@link io.github.hipstermin.idem.hub.kr.auth.validation.MemberDivisionPolicy} 에서 읽는다.
 */
@Documented

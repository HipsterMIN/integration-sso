...
// TODO 임의로 추가한 옵션 필요없을시 삭제 요청
export const RelativeDurationSuggestionOptionsV2: Option[] = [
	{ value: '5m', label: 'Last 5 mins' },
	{ value: '15m', label: 'Last 15 min' },
	{ value: '30m', label: 'Last 30 min' },
	{ value: '1h', label: 'Last 1 hr' },
	{ value: '3h', label: 'Last 3 hrs' },
	{ value: '6h', label: 'Last 6 hrs' },
	{ value: '12h', label: 'Last 12 hrs' },
	{ value: '1d', label: 'Last 1 day' },
	{ value: '3d', label: 'Last 3 days' },
	{ value: '1w', label: 'Last 1 wk' },
	// { value: '1w', label: 'Last 1 week' },
	{ value: '2w', label: 'Last 2 wks' },
	{ value: '1month', label: 'Last 1 mo' },
	{ value: '2months', label: 'Last 2 mos' },
	{ value: '1d', label: 'today' },
];
...
export const getDefaultOption = (_route?: string): Time => Options[2].value;

export const getOptions = (_route?: string): Option[] => Options;

 ...
 *
 * <p><b>코어 KMS(NHN SKM·Vault 등)와의 차이</b>:
 * <table>
...
public class AnyIdKmsClient {
    ...
    // ══════════════════════════════════════════════════════════════════════
    // 키 요청·복호화 API (종전 코어 KmsClient 시그니처 유지)
    // ══════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════
    // 예외 — 종전 코어 KmsClient 의 중첩 예외를 플러그인 내부로 (S5b)
    // ══════════════════════════════════════════════════════════════════════

    /** AnyID KMS 키 요청·복호화 실패. */
    public static class KmsDecryptException extends RuntimeException {
    ...
    /** AnyID KMS 암호화 실패. */
    public static class KmsEncryptException extends RuntimeException {

...
import io.github.hipstermin.idem.authz.api.scim.ScimGroup;
import io.github.hipstermin.idem.authz.api.scim.ScimGroupId;
import io.github.hipstermin.idem.authz.api.scim.ScimMember;
import io.github.hipstermin.idem.authz.api.scim.ScimPatchOp;
    ...
    public ScimGroup createGroup(String displayName, List<ScimMember> members, String actorIp) {
        ...
        if (!roleRepository.existsById(roleId)) {
            authzService.createRole(
                    new io.github.hipstermin.idem.authz.api.dto.CreateRoleRequest(

...
> - **[docs/internal/spec/03f-module-idem-console.md](../docs/internal/spec/03f-module-idem-console.md)** — onepass-fe 진입(Inbound) / 상태(State 4계층) / 송신(Outbound) 표면, CI 평문 처리 경로, IdO 엔드포인트 인벤토리, 위험 표면 (FE-RISK-01~07)

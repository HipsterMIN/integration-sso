...
export const DEFAULT_AUTH0_APP_REDIRECTION_PATH = ROUTES.HOME_PAGE;

export const IS_SIDEBAR_COLLAPSED = 'isSideBarCollapsed';
export const IS_SIDEBAR_HIDED = 'isSideBarHided';
export const INVITE_MEMBERS_HASH = '#invite-team-members';

export const UCUBE_UPGRADE_PLAN_URL =
	'https://upgrade.ucube.io/upgrade-from-app';

...
- **현재 버전**: **v1.0.1** (3차 적대적 점검 후속 PR-A/B/C, 2026-09-26 — 태그 `v1.0.1`; 1.0 동결은 S9 PR-4, 태그 `v1.0.0`, 릴리스 브랜치 `release/1.0`. 1.0 매뉴얼은 `docs/manuals/`, GS 착수는 `docs/certification/gs-kickoff.md`)

...
export const TOPMENU_POPUP_TOGGLE = 'TOPMENU_POPUP_TOGGLE';
export const TOPMENU_POPUP = 'TOPMENU_POPUP';
...
export interface TopMenuPopupToggle {
	type: typeof TOPMENU_POPUP_TOGGLE;
}

export interface TopMenuPopup {
	type: typeof TOPMENU_POPUP;
	payload: boolean;
}

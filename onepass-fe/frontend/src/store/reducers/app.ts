...
const InitialValue: InitialValueTypes = {
	...
	isSideBarHided: getLocalStorageKey(IS_SIDEBAR_HIDED) === 'true',
...
const appReducer = (
	...
	switch (action.type) {
		...
		case SIDEBAR_HIDE: {
			return {
				...state,
				isSideBarHided: action.payload,
			};
		}

		case TOPMENU_POPUP_TOGGLE: {
			return {
				...state,
				isTopMenuPopup: !state.isTopMenuPopup,
			};
		}

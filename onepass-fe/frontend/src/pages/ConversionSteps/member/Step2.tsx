...
function ConversionStep2({ memberType = 'member' }: Step2Props): JSX.Element {
	...
	if (loading) {
		return (
			<ConversionLayout
				currentStep={2}
				prevRoute={getConversionRoute(1, memberType)}
				nextRoute={getConversionRoute(3, memberType)}
				memberType={memberType}
				title="서비스 이용을 위해 아래의 내용에 동의해주세요"
			>

...
const routes: AppRoutes[] = [
	...
	{
		path: ROUTES.REGISTER_MINOR_STEP1,
		exact: true,
		component: RegisterMinorStep1,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP1',
	},
	{
		path: ROUTES.REGISTER_MINOR_STEP2,
		exact: true,
		component: RegisterMinorStep2,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP2',
	},
	{
		path: ROUTES.REGISTER_MINOR_STEP3,
		exact: true,
		component: RegisterMinorStep3,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP3',
	},
	{
		path: ROUTES.REGISTER_MINOR_STEP4,
		exact: true,
		component: RegisterMinorStep4,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP4',
	},
	{
		path: ROUTES.REGISTER_MINOR_STEP5,
		exact: true,
		component: RegisterMinorStep5,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP5',
	},
	{
		path: ROUTES.REGISTER_MINOR_STEP6,
		exact: true,
		component: RegisterMinorStep6,
		isPrivate: false,
		key: 'REGISTER_MINOR_STEP6',
	},
	{

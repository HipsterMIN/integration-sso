...
class OidcDiscoveryTest {
    ...
    void honestDocument() {
        Map<String, Object> d = OidcDiscovery.build("https://sso.example.org/realms/onepass");
        assertThat(d).containsEntry("issuer", "https://sso.example.org/realms/onepass")
                .containsEntry("authorization_endpoint", "https://sso.example.org/realms/onepass/protocol/openid-connect/auth")
                .containsEntry("token_endpoint", "https://sso.example.org/realms/onepass/protocol/openid-connect/token")
                .containsEntry("jwks_uri", "https://sso.example.org/realms/onepass/protocol/openid-connect/certs");
    ...
    void publicBaseAndPrefix() {
        ...
        p.setIssuer("https://sso.example.org:8443/realms/onepass");
        ...
        assertThat(p.isProvisionedClient("q-sign-client")).isFalse();

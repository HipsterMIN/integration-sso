...
public interface BizMemberConversionService {
     ...
     * @return 전환 결과
     * @throws kr.go.smes.common.exception.PlatformException E-IM-215 사업자등록번호 형식 오류
     * @throws kr.go.smes.common.exception.PlatformException E-IM-216 중복 사업자등록번호
     * @throws kr.go.smes.common.exception.PlatformException E-IM-201 사용자 없음
     */
     ...
     * @param correlationId 트레이싱 ID
     * @return 기업회원 정보
     * @throws kr.go.smes.common.exception.PlatformException E-IM-217 기업회원 정보 없음
     */

package kr.go.smes.qim.integration;

import kr.go.smes.common.domain.UserStatus;
import kr.go.smes.common.error.PlatformErrorCode;
import kr.go.smes.common.error.PlatformException;
import kr.go.smes.qim.biz.BizMemberConversionRequest;
import kr.go.smes.qim.biz.BizMemberConversionService;
import kr.go.smes.qim.biz.BizMemberConversionServiceImpl;
import kr.go.smes.qim.biz.BizMemberResult;
import kr.go.smes.qim.consent.*;
import kr.go.smes.qim.conversion.*;
import kr.go.smes.qim.crypto.PiiMaskingService;
import kr.go.smes.qim.guardian.GuardianConsentService;
import kr.go.smes.qim.guardian.GuardianConsentServiceImpl;
import kr.go.smes.qim.guardian.GuardianConsentStatus;
import kr.go.smes.qim.infrastructure.jpa.entity.*;
import kr.go.smes.qim.infrastructure.jpa.repository.*;
